...
// Script para incluir o menu lateral automaticamente em todas as páginas
    ...
    if (menuContainer) {
        fetch('/menu_lateral.html')
            ...
            .then(html => {
                ...
                // Após inserir o menu, inicialize os scripts do menu (se houver)
                if (typeof inicializarMenuLateral === "function") {
                    inicializarMenuLateral();
                }
            })
            .catch(error => {
                menuContainer.innerHTML = '<div style="color:red;text-align:center;">Erro ao carregar o menu.</div>';
                console.error('Erro ao carregar menu_lateral.html:', error);
            });
    }
});
